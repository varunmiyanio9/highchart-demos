...
function initMemberStackedLegendHCChart() {
    ...
    const GROUPS = [
        ...
        },
        {
            ...
            label: 'Product-2',
            members: [
                { id: 'item_1b',  name: 'Item-1',  color: '#FFC107', data: [78,82,72,67,88,80,74,77,90,98,82,74,78] },
                { id: 'item_2b',  name: 'Item-2',  color: '#FFD54F', data: [68,74,64,60,78,70,65,68,80,88,72,65,69] },
                { id: 'item_3b',  name: 'Item-3',  color: '#F9A825', data: [62,67,60,54,72,65,60,63,73,80,67,60,64] },
                { id: 'item_4b',  name: 'Item-4',  color: '#E07B28', data: [57,62,54,49,67,60,55,58,68,74,62,55,59] },
                { id: 'item_5b',  name: 'Item-5',  color: '#EF6C00', data: [52,57,50,45,62,55,50,53,63,68,57,50,54] },
                { id: 'item_6b',  name: 'Item-6',  color: '#D84315', data: [48,53,46,42,58,52,47,50,59,64,53,47,50] },
                { id: 'item_7b',  name: 'Item-7',  color: '#BF360C', data: [45,50,43,39,55,49,44,47,56,61,50,44,47] },
                { id: 'item_8b',  name: 'Item-8',  color: '#8B5E2E', data: [42,47,40,36,52,46,41,44,53,58,47,41,44] },
                { id: 'item_9b',  name: 'Item-9',  color: '#A1887F', data: [39,44,37,34,49,43,38,41,50,55,44,38,41] },
                { id: 'item_10b', name: 'Item-10', color: '#795548', data: [36,41,35,31,46,41,36,38,47,52,41,36,38] },
                { id: 'item_11b', name: 'Item-11', color: '#6D4C41', data: [34,38,32,29,43,38,33,36,44,49,39,33,36] },
                { id: 'item_12b', name: 'Item-12', color: '#5D4037', data: [31,36,30,27,40,36,31,33,42,46,36,31,33] },
                { id: 'item_13b', name: 'Item-13', color: '#5A3010', data: [29,33,28,25,38,33,29,31,39,43,34,29,31] },
                { id: 'item_14b', name: 'Item-14', color: '#3E2723', data: [27,31,26,23,35,31,27,29,37,41,32,27,29] },
                { id: 'item_15b', name: 'Item-15', color: '#2E1408', data: [25,28,24,21,33,29,25,27,34,38,29,25,27] },
                { id: 'item_16b', name: 'Item-16', color: '#FF8F00', data: [23,26,22,19,31,27,23,25,32,36,27,23,25] },
                { id: 'item_17b', name: 'Item-17', color: '#F57F17', data: [21,24,20,17,29,25,21,23,30,34,25,21,23] },
                { id: 'item_18b', name: 'Item-18', color: '#E65100', data: [19,22,18,16,27,23,19,21,28,32,23,19,21] },
                { id: 'item_19b', name: 'Item-19', color: '#DD2C00', data: [17,20,17,14,25,21,17,19,26,30,21,17,19] },
                { id: 'item_20b', name: 'Item-20', color: '#BF360C', data: [15,18,15,12,23,19,15,17,24,28,19,15,17] },
                { id: 'item_21b', name: 'Item-21', color: '#8D6E63', data: [14,17,14,11,21,18,14,16,22,26,18,14,16] },
                { id: 'item_22b', name: 'Item-22', color: '#6D4C41', data: [12,15,12,10,19,16,12,14,20,24,16,12,14] },
                { id: 'item_23b', name: 'Item-23', color: '#4E342E', data: [11,14,11,9,17,14,11,13,18,22,15,11,13] },
                { id: 'item_24b', name: 'Item-24', color: '#3E2723', data: [10,12,10,8,16,13,10,11,17,20,13,10,11] },
                { id: 'item_25b', name: 'Item-25', color: '#1B0000', data: [9,11,9,7,14,11,9,10,15,18,12,9,10] }
            ]
        },
        {
            id: 'product3',
            label: 'Product-3',
            members: [
                { id: 'item_1c',  name: 'Item-1',  color: '#FFC107', data: [62,70,57,52,74,67,60,64,74,82,70,62,66] },
                { id: 'item_2c',  name: 'Item-2',  color: '#FFD54F', data: [54,60,50,46,64,58,52,55,65,72,60,54,58] },
                { id: 'item_3c',  name: 'Item-3',  color: '#F9A825', data: [50,55,46,42,59,53,48,51,60,67,55,49,53] },
                { id: 'item_4c',  name: 'Item-4',  color: '#E07B28', data: [46,50,42,38,54,48,44,46,55,61,50,45,48] },
                { id: 'item_5c',  name: 'Item-5',  color: '#EF6C00', data: [42,46,38,34,49,44,40,42,50,56,45,40,44] },
                { id: 'item_6c',  name: 'Item-6',  color: '#D84315', data: [39,43,35,31,46,41,37,39,47,53,42,38,41] },
                { id: 'item_7c',  name: 'Item-7',  color: '#BF360C', data: [36,40,33,29,43,38,34,36,44,50,40,35,38] },
                { id: 'item_8c',  name: 'Item-8',  color: '#8B5E2E', data: [34,37,31,27,40,36,32,34,41,47,37,33,35] },
                { id: 'item_9c',  name: 'Item-9',  color: '#A1887F', data: [31,35,28,25,38,33,29,31,39,44,35,30,33] },
                { id: 'item_10c', name: 'Item-10', color: '#795548', data: [29,32,26,23,35,31,27,29,36,41,32,28,30] },
                { id: 'item_11c', name: 'Item-11', color: '#6D4C41', data: [27,30,24,21,33,29,25,27,34,38,30,26,28] },
                { id: 'item_12c', name: 'Item-12', color: '#5D4037', data: [25,28,22,19,30,27,23,25,31,36,28,24,26] },
                { id: 'item_13c', name: 'Item-13', color: '#5A3010', data: [23,26,20,18,28,25,21,23,29,33,26,22,24] },
                { id: 'item_14c', name: 'Item-14', color: '#3E2723', data: [21,24,19,16,26,23,19,21,27,31,24,20,22] },
                { id: 'item_15c', name: 'Item-15', color: '#2E1408', data: [19,22,17,14,24,21,18,19,25,28,22,19,20] },
                { id: 'item_16c', name: 'Item-16', color: '#FF8F00', data: [17,20,16,13,22,19,16,17,23,26,20,17,18] },
                { id: 'item_17c', name: 'Item-17', color: '#F57F17', data: [16,18,14,12,20,17,14,16,21,24,18,15,16] },
                { id: 'item_18c', name: 'Item-18', color: '#E65100', data: [14,16,13,10,18,16,13,14,19,22,16,14,15] },
                { id: 'item_19c', name: 'Item-19', color: '#DD2C00', data: [12,15,11,9,16,14,11,12,17,20,15,12,13] },
                { id: 'item_20c', name: 'Item-20', color: '#BF360C', data: [11,13,10,8,15,12,10,11,16,18,13,11,12] },
                { id: 'item_21c', name: 'Item-21', color: '#8D6E63', data: [10,12,9,7,13,11,9,10,14,16,12,10,11] },
                { id: 'item_22c', name: 'Item-22', color: '#6D4C41', data: [9,11,8,6,12,10,8,9,13,15,11,9,10] },
                { id: 'item_23c', name: 'Item-23', color: '#4E342E', data: [8,10,7,6,11,9,7,8,11,13,10,8,9] },
                { id: 'item_24c', name: 'Item-24', color: '#3E2723', data: [7,9,7,5,10,8,7,7,10,12,9,7,8] },
                { id: 'item_25c', name: 'Item-25', color: '#1B0000', data: [6,8,6,5,9,7,6,6,9,11,8,6,7] }
            ]
        }
    ];
